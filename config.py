...
class Config:
    ...
    # Database URI (convert postgres:// to postgresql:// for SQLAlchemy compatibility on Render)
    db_url = os.environ.get('DATABASE_URL')
    if db_url and db_url.startswith("postgres://"):
        db_url = db_url.replace("postgres://", "postgresql://", 1)
    SQLALCHEMY_DATABASE_URI = db_url or 'postgresql://postgres:12345678@localhost:5432/agrismart_db'
